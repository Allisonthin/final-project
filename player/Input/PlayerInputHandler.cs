...
public class PlayerInputHandler : MonoBehaviour
{
    ...
    public void OnMoveInput(InputAction.CallbackContext context)
    {
        ...
        // i skip some part for controller no for our keyboard
        // to get only x value and y value separately from raw input
    ...
    {
        // as soon as the button push down
        if (context.started)
        {
            DashInput = true;
            DashInputStop = false;
    ...
    public void OnDashDirectionInput(InputAction.CallbackContext context)
    {
        ...
        // rounding float value to nearest integer
